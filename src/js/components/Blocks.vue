<template>
    <div @dragenter.stop="dragenter" @dragleave.stop="dragleave" @drop.stop="drop" @dragover.prevent :style="{flex: 2, minHeight}">
        <template v-for="(item, index) in code"><!-- 因為template不能設定:key所以將template換成table -->
            <show v-if="'show' in item" :index="index" :calculable.sync="item.show" @drag="drag" @drop="drop" @dragstart="dragstart" @dragend="dragend" @dragenter="dragenter" @dragleave="dragleave" :context-menu-items="contextMenuItems" :context-menu-item-click="contextMenuItemClick"></show>
            ...
            <sleep v-else-if="'sleep' in item" :index="index" :calculable.sync="item.sleep" @drag="drag" @drop="drop" @dragstart="dragstart" @dragend="dragend" @dragenter="dragenter" @dragleave="dragleave" :context-menu-items="contextMenuItems" :context-menu-item-click="contextMenuItemClick"></sleep>
            ...
            <sc-option v-else-if="'text' in item" :index="index" :b-code.sync="item.then" :calculable.sync="item.text" @drag="drag" @drop="drop" @dragstart="dragstart" @dragend="dragend" @dragenter="dragenter" @dragleave="dragleave" :context-menu-items="contextMenuItems" :context-menu-item-click="contextMenuItemClick"></sc-option>
